...
def main(args):
    ...
    os.system(f"python preannotate.py --dataset {args.dataset} --config_file ../model/configs/{args.fp_config} --fp_ref ../../data/sc_references/sc_breast.csv --n_processes {args.n_processes}")
